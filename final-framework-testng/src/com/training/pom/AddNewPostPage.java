...
//3. click on Add New Category link of category section
	...
	public void addNewCategoryClick() throws InterruptedException {
...
//4. enter valid details in textbox
	...
	private WebElement createdCategory1;

	public void createdCategorySelected(String createdCategory1) {
		String start="//label[contains(text(),'";
		String end="')]";
		String CompleteXpath=start+createdCategory1+end;
		this.driver.findElement(By.xpath(CompleteXpath)).click();
		//this.createdCategory1.click();
	}
